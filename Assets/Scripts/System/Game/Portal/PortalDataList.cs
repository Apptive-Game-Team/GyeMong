...
public enum PortalID
{
    ...
    // Shadow Forest
    SPRING_TOWN_TO_SHADOW_FOREST = 7,
    SPRING_SHADOW_FOREST_TO_TOWN = 8,
    SPRING_ROAD_TO_SHADOW_FOREST = 9,
    SPRING_SHADOW_FOREST_TO_ROAD = 10,
    SPRING_SHADOW_FOREST_TO_BOSS_ROOM = 11,
    SPRING_BOSS_ROOM_TO_SHADOW_FOREST = 12,
