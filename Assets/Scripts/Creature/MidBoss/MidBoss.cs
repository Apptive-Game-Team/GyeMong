...
public class MidBoss : Boss
{
    ...
    protected override IEnumerator ExecutePattern1()//ø¯∞≈∏Æ »∞
    {
    ...
    protected override IEnumerator ExecutePattern2()//±Ÿ∞≈∏Æ
    {
        ChangeState(State.CHANGINGPATTERN);
    ...
    protected override IEnumerator ExecutePattern3()//√ﬂ¿˚
    {
    ...
    protected override IEnumerator ExecutePattern4()//ø¯∞≈∏Æ æææ—
    {
        ChangeState(State.CHANGINGPATTERN);
        yield return new WaitForSeconds(1f);
        float distance = Vector3.Distance(transform.position, player.transform.position);
    ...
    protected override IEnumerator ExecutePattern5()//µ¢ƒ »÷µŒ∏£±‚
    {
        ChangeState(State.CHANGINGPATTERN);
        yield return new WaitForSeconds(0.5f);
        ChangeState(State.ATTACK);
