...
namespace Creature.Boss.Component.SkillIndicator
{
    public class SkllIndicatorDrawer : MonoBehaviour
    {
        ...
        public void DrawIndicator(IndicatorType type, Vector3 startPosition, Transform target, float range, float duration, float delay)
        {
            ...
            StartCoroutine(indicator.GrowIndicator(startPosition, target, range, duration, delay - 0.1f));
        }
